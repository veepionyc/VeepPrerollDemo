...
/**
 This is taken from Google's basic sample code
 https://developers.google.com/interactive-media-ads/docs/sdks/ios/
 
 */

class GoogleViewController: UIViewController, IMAAdsLoaderDelegate, IMAAdsManagerDelegate {
    ...
    func setUpContentPlayer() {
        ...
        guard let contentURL = URL(string: GoogleViewController.kTestAppContentUrl_MP4) else {
